...
public class Blank extends AppCompatActivity {
  ...
  ArrayList<EventAdapter> itemlist;
    ...
    protected void onResume() {
        super.onResume();
        event_card_adapter.setOnItemClickListener(new Event_Card_Adapter.MyClickListener(){

            @Override
            public void onItemClick(int position, View v) {
                  Intent intent = new Intent(Blank.this,EventCardClickActivity.class);
                  intent.putExtra("building",itemlist.get(position).getBuilding());
